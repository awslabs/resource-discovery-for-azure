...
$ExpectedSchema = @{
    ...
    'SQL DBs' = @('Subscription', 'ResourceGroup', 'Name', 'Location', 'StorageAccountType', 'DatabaseServer', 'SecondaryLocation', 'Status', 'Type', 'Tier', 'Sku', 'License', 'Capacity', 'DataMaxSizeGB', 'ZoneRedundant', 'CatalogCollation', 'ReadReplicaCount', 'ElasticPoolID')
